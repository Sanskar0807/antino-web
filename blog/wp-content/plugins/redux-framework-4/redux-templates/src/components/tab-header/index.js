        ...
        <div className="redux-templates-builder-modal-header">
            ...
            <div className="redux-templates-template-list-header" data-tut="tour__navigation">
                ...
                <button className="redux-templates-builder-close-modal" onClick={closeModal} >
					<svg width="24" height="24" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M13 11.9l3.3-3.4-1.1-1-3.2 3.3-3.2-3.3-1.1 1 3.3 3.4-3.5 3.6 1 1L12 13l3.5 3.5 1-1z"></path></svg>
                </button>
            </div>
        </div>
    );
